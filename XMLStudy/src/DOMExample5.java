...
public class DOMExample5 {
	public static void main(String[] args) throws Exception {
		...
		booklistElement.removeChild(bookElement); //appendChild는 생성하는 것
		System.out.println("[디버깅]: 삭제후 book 엘리먼트 갯수: " + booklistElement.getChildNodes().getLength()); //메모리 상에서의 삭제일 뿐, 파일은 그대로
